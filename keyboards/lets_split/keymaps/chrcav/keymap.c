...
[_QWERTY] = LAYOUT_ortho_4x12( \
   ...
   KC_LCTL, ADJUS,  KC_LGUI, KC_LALT, LOWER,   KC_BSPC, KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),

[_LOWER] = LAYOUT_ortho_4x12( \
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,  \
  KC_DEL,  KC_CAPP, KC_LEFT, KC_RGHT, KC_UP,   KC_LBRC, KC_RBRC, _______, _______, _______, _______, KC_BSLS, \
  _______, KC_CPYP, _______, _______, KC_DOWN, KC_LCBR, KC_RCBR, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY  \
),

[_RAISE] = LAYOUT_ortho_4x12( \
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,  \
  KC_DEL , KC_MPRV, KC_MNXT, KC_VOLU, KC_PGUP, KC_MINS, KC_EQL,  KC_HOME, _______, _______, _______, KC_PIPE, \
  KC_MUTE, KC_MSTP, KC_MPLY, KC_VOLD, KC_PGDN, KC_UNDS, KC_PLUS, KC_END,  KC_THMUP,_______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY  \
),

[_ADJUST] =  LAYOUT_ortho_4x12( \
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  \
  QK_BOOT, _______, _______, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, UC_LINX, UC_WIN,  _______, _______, _______, _______, _______, \
